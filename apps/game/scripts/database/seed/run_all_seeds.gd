...
var SeedBlockType = load("res://scripts/database/seed/seed_block_type.gd")
var SeedBlocks = load("res://scripts/database/seed/seed_blocks.gd")
var SeedLevels = load("res://scripts/database/seed/seed_levels.gd")
var SeedSegments = load("res://scripts/database/seed/seed_segments.gd")
var SeedSegmentBlocks = load("res://scripts/database/seed/seed_segment_blocks.gd")
