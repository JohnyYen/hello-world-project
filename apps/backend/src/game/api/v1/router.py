...
from src.game.api.v1.endpoints.create_game_instance import (
    router as create_game_instance_router,
)
from src.game.api.v1.endpoints.list_game_instances import (
    router as list_game_instances_router,
)
...
from src.game.api.v1.endpoints.create_game_level import (
    router as create_game_level_router,
)
from src.game.api.v1.endpoints.get_level_segments import (
    router as get_level_segments_router,
)
from src.game.api.v1.endpoints.create_level_segment import (
    router as create_level_segment_router,
)
