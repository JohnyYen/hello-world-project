...
opencode run "@apps/frontend/PRD.json @$APP_PATH/AGENTS.md @progress.txt \
...
3. Implementa la tarea siguiendo estrictamente los patrones arquitectónicos y de código definidos en el AGENTS.md. \
